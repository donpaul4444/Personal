...
$("#social-media-linedin").click(function () {
	window.open("https://www.linkedin.com/in/don-paul-9395777a", "_blank");
});
$("#social-media-github").click(function () {
	window.open("https://github.com/donpaul4444", "_blank");
});
$("#social-media-youtube").click(function () {
	window.open("https://www.youtube.com/channel/UCT8tc2KA6-VbHT0lR4vOrcA", "_blank");
});

$("#social-media-whatsapp").click(function () {
	window.open("https://wa.me/message/UGOFX2OOIMVCM1", "_blank");
});
